    ...
    return loading ? <div className="h-screen w-screen flex justify-center items-center">
        ...
        <div>
            ...
            <div className="text-center my-10">
                <h2 className="my-5 text-3xl">Who Can Benefit from Our Platform?</h2>
                <div className="max-w-6xl mx-auto space-y-3">
                    <div className="collapse bg-base-200">
                        ...
                        <div className="collapse-content">
                            <p>Streamline your project management by collaborating on tasks with your development team</p>
                        </div>
                    </div>
                    <div className="collapse bg-base-200">
                        <input type="radio" name="my-accordion-1" />
                        ...
                        <div className="collapse-content">
                            <p>Plan and execute code sprints with ease, keeping everyone on the same page.</p>
                        </div>
                    </div>
                    <div className="collapse bg-base-200">
                        <input type="radio" name="my-accordion-1" />
                        ...
                        <div className="collapse-content">
                            <p>Manage and oversee various projects effortlessly with our intuitive task dashboard.</p>
                        </div>
                    </div>
                    <div className="collapse bg-base-200">
                        <input type="radio" name="my-accordion-1" />
                        ...
                        <div className="collapse-content">
                            <p>Plan and execute your business strategies seamlessly with a clear overview of tasks.</p>
                        </div>
                    </div>
                    <div className="collapse bg-base-200">
                        <input type="radio" name="my-accordion-1" />
                        ...
                        <div className="collapse-content">
                            <p>Whether you are handling code, projects, deals, or studies, our platform offers a comprehensive solution for efficient task management.</p>
                        </div>
                    </div>
                </div>
            </div>
            <footer className="footer footer-center p-10 bg-black text-primary-content mt-10">
                <aside>
                    ...
                    <p className="font-bold">
                        Task Manager <br />Providing serverces since 2023
                    </p>
